 ...
 * 
 */
@WebServiceClient(name = "ClientWebServiceService", targetNamespace = "http://impl.client.notary.sec/", wsdlLocation = "http://localhost:9090/user0WebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CLIENTWEBSERVICESERVICE_QNAME = new QName("http://impl.client.notary.sec/", "ClientWebServiceService");
    ...
    public ClientWebService getClientWebServicePort() {
        return super.getPort(new QName("http://impl.client.notary.sec/", "ClientWebServicePort"), ClientWebService.class);
    }
    ...
    public ClientWebService getClientWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.client.notary.sec/", "ClientWebServicePort"), ClientWebService.class, features);
    }
